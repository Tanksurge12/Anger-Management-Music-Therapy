...
function switchPage(pageID){
	getEByID("main").style.visibility=hidden;
	getEByID("overview").style.visibility=hidden;
	getEByID("in-depth").style.visibility=hidden;
	getEByID(pageID).style.visibility=visible;
}
